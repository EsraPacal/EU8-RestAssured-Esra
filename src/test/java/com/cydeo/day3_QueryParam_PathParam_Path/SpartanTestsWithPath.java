...
/*
   ...
   */
    ...
    public void test1(){
        ...
        assertEquals(3312820936l,phone);   // don't forget put an "l" for the long numbers...
    ...
    public void test2(){
        ...
        int firstId = response.path("id[0]");  //it navigates to second one ----> index number 1 == 2.object
        System.out.println("firstId = " + firstId);

        String name= response.path("name[0]");
        System.out.println("name = " + name);

        String lastFirstName = response.path("name[-1]");  // last Index
        ...
        for (String n : names) {
            System.out.println(n);  //iterate all the name in the list
