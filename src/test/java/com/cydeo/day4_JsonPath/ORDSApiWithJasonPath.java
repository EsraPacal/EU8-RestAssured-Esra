...
public class ORDSApiWithJasonPath extends HRTestBase {
    ...
    public void test1(){
        ...
        {it.region_id==2}  ------> each region_id of the countries == 2 ----->  like "if" condition
    ...
    public void test2(){
        ...
        //get me all email of employees who are working as IT_PROG
        ...
        List<String> employeeFirstNames = jsonPath.getList("items.findAll {it.salary>10000}.first_name");
        System.out.println(employeeFirstNames);

        //get me max salary first name
