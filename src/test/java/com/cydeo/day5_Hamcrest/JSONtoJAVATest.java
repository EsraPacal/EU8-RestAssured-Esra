package com.cydeo.day5_Hamcrest;
...
public class JSONtoJAVATest extends SpartanTestBase {
    ...
    public void oneSpartanToMap(){
        ...
        Map<String,Object> jsonMap = response.as(Map.class);// as(Map.class)---> we reach to only one object inside the ArrayList
    ...
    public void getAllSpartan(){
        ...
        List<Map<String,Object>> jsonList = response.as(List.class); //as(List.class)---> we reach to all objects inside the List
