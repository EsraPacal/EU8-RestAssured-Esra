...
public class ORDSPojoGetRequestTest extends HRTestBase {
    ...
    public void regionTest(){
        ...
        Link link1 = region1.getLinks().get(0);  // return us the first link...
    ...
    public void regionGet(){
        ...
        List<String> regionNames = new ArrayList<>();  //empty list
        List<Integer> regionIds = new ArrayList<>();  // empty list

        //get list of regions out of regions object
        List<Region> items = regions.getItems();

        //loop through each of the region, save their ids and names to empty list that we created
