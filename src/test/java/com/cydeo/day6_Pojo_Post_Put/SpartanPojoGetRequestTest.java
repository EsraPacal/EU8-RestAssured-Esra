package com.cydeo.day6_Pojo_Post_Put;
...
public class SpartanPojoGetRequestTest extends SpartanTestBase {
    ...
    public void oneSpartanPojo(){
        ...
        Spartan spartan15 = response.as(Spartan.class);  //--->converting the json object to java custom class
        ...
        Spartan s15 = jsonPath.getObject("",Spartan.class);  //another more useful way to convert the json ob. to java
        System.out.println(s15);
        System.out.println("s15.getName() = " + s15.getName());
        System.out.println("s15.getPhone() = " + s15.getPhone());

        //Spartan s15 = jsonPath.getObject("",Spartan.class);
        // ---> the benefit of using this way is that this deserialization accepts also  "path"
    ...
    @DisplayName("GET /spartan/search and save as List<Spartan>")
    @Test
    public void test4(){
        ...
        //alternative solution by creating a new Search class related to Spartan class
    }
