 ...
 */
    ...
    public void postMethod1(){
        ...
        //Hey, API! send me Content-type Json (accept(ContentType.JSON). (asking API to send Content-type Json
        //Hey, API! I'm sending Json to you (contentType(ContentType.JSON)
        Response response = given().accept(ContentType.JSON).and()
                .contentType(ContentType.JSON)
                .body(requestJsonBody)  // we could insert the String data inside directly, but we store it into the String variable
                .when()
                .post("/api/spartans");
        ...
        assertThat(response.path("data.phone"),is(8877445596l));  // we need to cast string to primitive
    }
    ...
    public void postMethod4(){
        ...
        //create one object from your pojo, send it as a JSON
        Spartan spartan = new Spartan();
        spartan.setName("JohnLock");
        spartan.setGender("Male");
        spartan.setPhone(8877445597L);
